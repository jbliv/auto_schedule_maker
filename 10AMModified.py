...
class MasterMaker:
    ...
    def createSchedules(self, officers) -> list:
        ...
        while stack != []:
            ...
            if testing == 100000:
                testingHundo += 1
                testing = 0
                print("Current bottom of stack:")
                print(stack[0][0])
                print(testingHundo, " Hundred Thousand Nodes tested")
                print(len(stack), " items in Stack")
                print(len(solutions), " Solutions Found")
            if testingHundo == 1000 and solutions == []:
                break
            elif testingHundo == 10000:
                break
    ...
    def optimalSchedule(self) -> Schedule:
        ...
        while not legalSchedules:
            ...
            if possibles != []:
                legalSchedules = True
                possibles = self.compareSchedules(possibles, scheduleSet)
...
def main():
    ...
    output = xl.load_workbook("Template10.xlsx")
    ...
    output.save("OfficeHours10.xlsx")
